...
class Location {
  ...
  static List<Location> fetchAll() {
    return [
      ...
      Location(
          id: 2,
          name: 'Mount Fuji',
          imagePath: 'assets/images/corgi.jpg',
      ...
      Location(
          ...
          imagePath: 'assets/images/fluff.jpg',
  ...
  static Location fetchByID(int locationID) {
    //fetch all locations, iterate them and when we find the location with the ID we want, return it immediately
